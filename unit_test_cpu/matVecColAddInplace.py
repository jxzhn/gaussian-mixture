...
# 设置参数类型
gmm_matrix_support.matVecColAddInplace.argtypes = [
...
answer = testcase + vec[:, np.newaxis]

gmm_matrix_support.matVecColAddInplace(testcase, vec, testcase.shape[0], testcase.shape[1])
